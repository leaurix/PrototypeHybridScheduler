...
class HybridSchedulingPipeline:
    """
    Full thesis-aligned scheduling pipeline:
    1. Build CSP feasibility layer
    2. Create validator
    3. Run GA
    4. Run ALNS
    5. Use FGASP controller + feedback to select best result
    """
    ...
    def build(self):
        # CSP feasibility model
        csp = CSPModel(self.dataset)
